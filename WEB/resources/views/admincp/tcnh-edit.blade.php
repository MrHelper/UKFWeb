	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">Thi công nhà hàng</h3>
					</div>
					<div class="panel-body">
						<div class="form-group">
							<input type="text" class="form-control" id="title"  placeholder="Tiêu đề" required value="{{$DuAn->title}}">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" id="description"  placeholder="Tóm tắt" required value="{{$DuAn->description}}">
						</div>
						<div class="form-group">
