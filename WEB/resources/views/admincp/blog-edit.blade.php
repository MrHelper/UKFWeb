			...
			<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group">
							<input type="text" class="form-control" id="title"  placeholder="Tiêu đề" required value="{{$Blog->title}}">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" id="categlory"  placeholder="Tóm tắt" required value="{{$Blog->categlory}}">
						</div>
						<div class="form-group">
						...
						<hr>
	                    <div class="form-group">
	                    <button id="btnAccept" tkID="{{$Blog->id}}" type="button" class="btn btn-primary">Chấp nhận</button>
	                    <button id="btnCancel" type="button" class="btn btn-primary">Huỷ</button>
	                    <button id="btnDelete" tkID="{{$Blog->id}}" type="button" class="btn btn-danger pull-right">Xoá</button>
	                    </div>
					</div>
				</div>
		...
		function EditDuAn(){
			...
			$.ajax({
	            ...
	            success:function(data){
	                $('#LoadingDiv').fadeOut();
	                location.href = '{{route('admincp.L-TCNH')}}';
	            }
	        });
		}
